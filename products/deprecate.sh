...
${APIC_CLI} products:update -s ${APIMGR_SERVER} -o ${ORG_NAME_SLUGIFIED} -c ${CATALOG_NAME_SLUGIFIED} --scope ${SCOPE} ${PRODUCT_NAME_SLUGIFIED}:${PRODUCT_VERSION} deprecate.json