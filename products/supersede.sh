...
echo "${APIC_CLI} products:supersede -s ${APIMGR_SERVER} -o ${ORG_NAME} -c ${CATALOG_NAME} --scope ${SCOPE} ${NEW_PRODUCT_NAME}:${NEW_PRODUCT_VERSION} supersede.yaml"
${APIC_CLI} products:supersede -s ${APIMGR_SERVER} -o ${ORG_NAME} -c ${CATALOG_NAME} --scope ${SCOPE} ${NEW_PRODUCT_NAME}:${NEW_PRODUCT_VERSION} supersede.yaml