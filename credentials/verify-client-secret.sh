...
${APIC_CLI} credentials:verify-client-secret -s ${APIMGR_SERVER} --org ${ORG_NAME} --catalog ${CATALOG_NAME} --consumer-org ${CONSUMER_ORG_NAME} --app ${APP_NAME} ${CREDENTIAL_NAME} credential.json --format json --output -
rm credential.json